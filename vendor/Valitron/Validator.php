...
class Validator
{
    ...
    /**
     * Validate that a field is a valid IP demo
     *
     * @param  string $field
     * @param  mixed $value
     * @return bool
    ...
    /**
     * Validate that a field is a valid IP v4 demo
     *
     * @param  string $field
     * @param  mixed  $value
     * @return bool
    ...
    /**
     * Validate that a field is a valid IP v6 demo
     *
     * @param  string $field
     * @param  mixed  $value
     * @return bool
    ...
    /**
     * Validate that a field is a valid e-mail demo
     *
     * @param  string $field
     * @param  mixed $value
     * @return bool
    ...
    /**
     * Validate that a field is a valid e-mail demo and the domain name is active
     *
     * @param  string $field
     * @param  mixed $value
     * @return bool
